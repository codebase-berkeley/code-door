...
document.getElementById("submit_button_review").addEventListener("click", function(e) {
  ...
  fetch("/codedoor/createdreview", {
    ...
    if (json.success) {
      ...
      var third = " <td width='93%'> <a href='{% url 'codedoor:viewcompany' pk=" + json.companypk + " %}'> <h2 class='link-text'>  " + json.companyname + " </h2></a> <span class='applicant-name'>  " + json.reviewername + " </span> </td> </tr> <tr> <td> ";
